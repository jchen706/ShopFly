...
# Define a videowriter object for the webcam
VideoFileOutput=cv2.VideoWriter(filename,codec,framerate, resolution)

# Define a map of items to item code for lookup
items = {}
itemList = []

def pullNCRData(itemCode):
    return 1
  ...
  with tf.Session(graph=detection_graph) as sess:
      ...
      while (ret):
          ...
          if name not in items:
              items[name] = 1
              itemList.append(pullNCRData(items.get(name)))
